...
class BinaryNode<K extends Comparable<K>>
{
    ...
    BinaryNode<K> left;         // Left child
    BinaryNode<K> right;        // Right child
}
...
public class SplayTree<K extends Comparable<K>>
{
    ...
    private BinaryNode<K> header = new BinaryNode<>(null); // For splay
     ...
     *   less than key in the tree, or the least key > key in the tree.
     *
